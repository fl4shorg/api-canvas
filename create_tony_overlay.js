...
(async () => {
  const tpl = await loadImage(path.join(__dirname, 'templates', 'tonyquadro_template.jpg'));
  ...
  fs.writeFileSync(path.join(__dirname, 'templates', 'tonyquadro_overlay.png'), canvas.toBuffer('image/png'));
  console.log('✓ Overlay criado com detecção de componentes conectados');
})();
